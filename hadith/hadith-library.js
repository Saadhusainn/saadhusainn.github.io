...
const BOOKS_MANIFEST = [
    {
        ...
        file: "https://cdn.jsdelivr.net/gh/saadhusainn/saadhusainn.github.io@main/hadith/data/bukhari.json",
        // Fallback local file
        localFile: "data/bukhari.json",
        name_en: "Ṣaḥīḥ al-Bukhārī",
        name_ar: "صحيح البخاري",
        icon: "../assets/book-icons/bukhari.png",
        count: 7563,
        version: 1
    },
    {
        id: "muslim",
        file: "https://cdn.jsdelivr.net/gh/saadhusainn/saadhusainn.github.io@main/hadith/data/muslim.json",
        localFile: "data/muslim.json",
        name_en: "Ṣaḥīḥ Muslim",
        name_ar: "صحيح مسلم",
        icon: "../assets/book-icons/muslim.png",
        count: 7500,
        version: 1
    },
   {
        id: "abudawud",
        file: "https://cdn.jsdelivr.net/gh/saadhusainn/saadhusainn.github.io@main/hadith/data/abudawud.json",
        localFile: "data/abudawud.json",
        name_en: "Sunan Abū Dāwūd",
        name_ar: "سُنَنُ أَبِي دَاوُد",
        icon: "../assets/book-icons/abudawud.png",
        count: 5274,
        version: 1
   },
   {
        id: "tirmidhi",
        file: "https://cdn.jsdelivr.net/gh/saadhusainn/saadhusainn.github.io@main/hadith/data/tirmidhi.json",
        localFile: "data/tirmidhi.json",
        name_en: "Jamiʿ al-Tirmidhī",
        name_ar: "جَامِعُ التِّرْمِذِي",
        icon: "../assets/book-icons/tirmidhi.png",
        count: 3605,
        version: 1
   },
      {
        id: "nasai",
        file: "https://cdn.jsdelivr.net/gh/saadhusainn/saadhusainn.github.io@main/hadith/data/nasai.json",
        localFile: "data/nasai.json",
        name_en: "Sunan al-Nasāʾī",
        name_ar: "سُنَنُ النَّسَائِي",
        icon: "../assets/book-icons/nasai.png",
        count: 5758,
        version: 1
   },
      {
        id: "ibnmajah",
        file: "https://cdn.jsdelivr.net/gh/saadhusainn/saadhusainn.github.io@main/hadith/data/ibnmajah.json",
        localFile: "data/ibnmajah.json",
        name_en: "Sunan Ibn Mājah",
        name_ar: "سُنَنُ ابِنِ مَاجَة",
        icon: "../assets/book-icons/ibnmajah.png",
        count: 4341,
        version: 1
   },
      {
        id: "darimi",
        file: "https://cdn.jsdelivr.net/gh/saadhusainn/saadhusainn.github.io@main/hadith/data/darimi.json",
        localFile: "data/darimi.json",
        name_en: "Sunan al-Dārimī",
        name_ar: "سُنَنُ الدَّارِمِي",
        icon: "../assets/book-icons/darimi.png",
        count: 3546,
        version: 1
   },
      {
        id: "malik",
        file: "https://cdn.jsdelivr.net/gh/saadhusainn/saadhusainn.github.io@main/hadith/data/malik.json",
        localFile: "data/malik.json",
        name_en: "Muwaṭṭaʾ Mālik",
        name_ar: "مُوَطَّأُ مَالِك",
        icon: "../assets/book-icons/malik.png",
        count: 1975,
        version: 1
   },
      {
        id: "ibnhibban",
        file: "https://cdn.jsdelivr.net/gh/saadhusainn/saadhusainn.github.io@main/hadith/data/ibnhibban.json",
        localFile: "data/ibnhibban.json",
        name_en: "Ṣaḥīḥ Ibn Ḥibbān",
        name_ar: "صحيح ابن حبّان",
        icon: "../assets/book-icons/ibnhibban.png",
        count: 7491,
        version: 1
   }
